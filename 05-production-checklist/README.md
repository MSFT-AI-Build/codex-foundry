...
- 사용자, credential, trace, 보안, 거버넌스의 담당자와 통제를 결정합니다.
...
**완료 결과:** 각 통제 항목의 담당자, 완료일, 증적 링크가 포함된 Go-Live 승인 체크리스트를 만듭니다.
...
| --- | --- | --- | --- |
| 사용자와 접근 권한 | IAM / 플랫폼 팀 | 개발 조직 관리자 | 가입·변경·탈퇴 절차 |
...
- [ ] 사용자·권한: 그룹, 역할, onboarding/offboarding과 비상 접근이 승인되었다.
